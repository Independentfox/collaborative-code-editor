  ...
  return (
    <div className='homePageWrapper'>
      ...
      <div className='background4'>
        ...
        <h1 className='name'><i>IGNITE-Code</i></h1>
        <h1>Share code in Real-time with Developers</h1>
        
        <h3 className='about'> IgniteCode is a realtime code-editor and compiler where you can write your code in realtime with your partners with functionality to run it. </h3>
